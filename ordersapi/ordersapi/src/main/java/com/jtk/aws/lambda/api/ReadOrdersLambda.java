...
public class ReadOrdersLambda {
    ...
    public APIGatewayProxyResponseEvent getOrders(APIGatewayProxyRequestEvent apiGatewayProxyRequestEvent)
            throws JsonProcessingException {

        ScanResult scan = dynamoDB.scan(new ScanRequest().withTableName(System.getenv("ORDERS_TABLE")));
        List<Order> listOfItems = scan.getItems()
                .stream()
        ...
        String jsonString = objectMapper.writeValueAsString(listOfItems);
